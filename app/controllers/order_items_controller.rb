...
class OrderItemsController < ApplicationController
  ...
  SHIP_EST_UPS = Rails.env.production? ? "https://adaships.herokuapp.com/estimate/ups" : "http://localhost:3001/estimate/ups"
