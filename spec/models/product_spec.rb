...
RSpec.describe Product, type: :model do
  ...
  describe "Validations" do
    ...
    it "requires that a product name be unique" do
      product = Product.create(name: "fancy cat fedora", price:1.5, user_id: 2, status: "active")
  ...
  describe "Scopes" do
    it "retrieves only active product records" do
      active_product = Product.create(name: "Cat Safety Hat", price: 1, user_id: 1, status: "active")
      retired_product = Product.create(name: "Bat Safety Hat", price: 1, user_id: 1, status: "retired")
