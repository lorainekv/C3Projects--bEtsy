...
products =[
  ...
  {name: "Goat Safety Vest", price: "25", description:"For the working goat eating the fields to the helpful roadside assistance goat, this safety vest is essential for increasing visibility and safety of your goat. Would also be required for any Village Goat Group Member for genuine authenticity.", stock: "4", photo_url: "safetyvestgoat.jpg", user_id: "1", category_id: "1"
  },

  {name: "Goat Red Flannel", price: "30", description:"Thanks to the Grunge movement that never seemed to die, there's never been a wider assortment of flannel available for all goats. This jewel is the classic Red that will surely stand out in a crowd and set your goat up for their next journey whether around the world with their band, or around the farm.", stock: "2", photo_url: "goatinflannel.jpg", user_id: "1", category_id: "1"
  },
